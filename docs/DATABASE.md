...
device registration planning, device access policy checks, and conflicts, but
live provider workers and offline device/queue/conflict writes remain disabled
until later phases.
