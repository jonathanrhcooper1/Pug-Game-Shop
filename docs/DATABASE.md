...
filters, conflict resolution requests, and conflicts, but live provider workers
and offline device/queue/conflict writes remain disabled until later phases.
