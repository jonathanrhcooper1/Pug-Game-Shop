...
pull request validation, pull response presentation, and conflicts, but live
provider workers and offline device/queue/conflict writes remain disabled until
later phases.
