...
Status: Implemented; staging integration acceptance pending
...
mock-backed ScryDex provider adapter, and card/price normalization implemented
...
Status: In progress; exact reservation schema plus reserve/release/convert
service foundations implemented
