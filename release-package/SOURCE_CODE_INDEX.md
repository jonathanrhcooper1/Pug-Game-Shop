...
| apps/offline-app/src-tauri/target/debug/.fingerprint/tcg-store-offline-0cafb37648ba0131/build-script-build-script-build.json | Offline app Windows shell source | .json | Covered by package/build/smoke tests or pending targeted test |
| apps/offline-app/src-tauri/target/debug/.fingerprint/tcg-store-offline-18a5315f855cd863/test-lib-tcg_store_offline_lib.json | Offline app Windows shell source | .json | Covered by related unit/contract test |
| apps/offline-app/src-tauri/target/debug/.fingerprint/tcg-store-offline-2015da24800199bc/test-bin-tcg-store-offline.json | Offline app Windows shell source | .json | Covered by related unit/contract test |
| apps/offline-app/src-tauri/target/debug/.fingerprint/tcg-store-offline-28369af183803b43/run-build-script-build-script-build.json | Offline app Windows shell source | .json | Covered by package/build/smoke tests or pending targeted test |
| apps/offline-app/src-tauri/target/debug/.fingerprint/tcg-store-offline-e55d531b7efae375/lib-tcg_store_offline_lib.json | Offline app Windows shell source | .json | Covered by related unit/contract test |
...
| apps/offline-app/src-tauri/target/debug/build/tcg-store-offline-28369af183803b43/out/__global-api-script.js | Offline app Windows shell source | .js | Covered by package/build/smoke tests or pending targeted test |
| apps/offline-app/src-tauri/target/debug/build/tcg-store-offline-28369af183803b43/out/acl-manifests.json | Offline app Windows shell source | .json | Covered by package/build/smoke tests or pending targeted test |
| apps/offline-app/src-tauri/target/debug/build/tcg-store-offline-28369af183803b43/out/capabilities.json | Offline app Windows shell source | .json | Covered by package/build/smoke tests or pending targeted test |
...
| apps/offline-app/src-tauri/target/x86_64-pc-windows-msvc/release/.fingerprint/tcg-store-offline-e55d531b7efae375/bin-tcg-store-offline.json | Offline app Windows shell source | .json | Covered by related unit/contract test |
| apps/offline-app/src-tauri/target/x86_64-pc-windows-msvc/release/.fingerprint/tcg-store-offline-e55d531b7efae375/lib-tcg_store_offline_lib.json | Offline app Windows shell source | .json | Covered by related unit/contract test |
...
| scripts/tests/lan-server-upgrade-script-contract.mjs | Build/deployment/test automation | .mjs | Test file |
