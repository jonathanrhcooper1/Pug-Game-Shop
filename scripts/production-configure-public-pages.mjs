...
const pages = [
  {
    ...
    title: "Shop Singles",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--singles"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Live singles inventory</p><h2>Singles vault</h2><p>Search real-time card inventory by game, set, card name, condition, price, and in-stock quantity. Choose a card to select the exact condition/version before checkout.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-graded-cards/">Graded</a><a href="/events/">Events</a><a href="/buying/">Buying</a><a href="/contact/">Contact</a></nav><div class="tcg-storefront-shelf__stats"><div class="tcg-storefront-shelf__stat"><span>Online</span><strong>Live stock</strong></div><div class="tcg-storefront-shelf__stat"><span>Cards</span><strong>Images + prices</strong></div><div class="tcg-storefront-shelf__stat"><span>Checkout</span><strong>Exact copy</strong></div></div></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>The Pug</span><strong>Cards, games, and more</strong></aside></section>[tcg_inventory_search raw_or_graded="raw" limit="48"]</div>',
  },
  {
    slug: "shop-graded-cards",
    title: "Shop Graded Cards",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--graded"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Slabs and showcase cards</p><h2>Graded cards</h2><p>Certified cards added through intake publish here when they are made visible online, with grades and cert details preserved in inventory.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-graded-cards/">Graded</a><a href="/events/">Events</a><a href="/contact/">Contact</a></nav></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>Graded</span><strong>Slabs and showcase cards</strong></aside></section>[tcg_product_shelf category="graded-cards" label="Graded Cards" limit="24"]</div>',
  },
  {
    slug: "card-inventory",
