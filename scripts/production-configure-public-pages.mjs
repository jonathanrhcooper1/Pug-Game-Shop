...
const pages = [
  {
    ...
    title: "Shop Singles",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--singles"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Live singles inventory</p><h2>Singles vault</h2><p>Search real-time card inventory by game, set, card name, condition, price, and in-stock quantity. Choose a card to select the exact condition/version before checkout.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-sealed-products/">Sealed</a><a href="/shop-graded-cards/">Graded</a><a href="/shop-accessories/">Accessories</a><a href="/events/">Events</a><a href="/buying/">Buying</a><a href="/contact/">Contact</a></nav><div class="tcg-storefront-shelf__stats"><div class="tcg-storefront-shelf__stat"><span>Online</span><strong>Live stock</strong></div><div class="tcg-storefront-shelf__stat"><span>Cards</span><strong>Images + prices</strong></div><div class="tcg-storefront-shelf__stat"><span>Checkout</span><strong>Exact copy</strong></div></div></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>The Pug</span><strong>Cards, games, and more</strong></aside></section>[tcg_inventory_search limit="36"]</div>',
  },
  {
    slug: "shop-sealed-products",
    title: "Shop Sealed Products",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--sealed"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Boxes, packs, bundles</p><h2>Sealed product</h2><p>Fresh sealed product, preorders, bundles, and display-ready drops grouped away from singles so shoppers can move fast.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-sealed-products/">Sealed</a><a href="/shop-graded-cards/">Graded</a><a href="/shop-accessories/">Accessories</a><a href="/events/">Events</a><a href="/contact/">Contact</a></nav></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>Sealed</span><strong>Boxes, packs, bundles</strong></aside></section>[tcg_product_shelf category="sealed-products" label="Sealed Products" limit="24"]</div>',
  },
  {
    slug: "shop-graded-cards",
    title: "Shop Graded Cards",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--graded"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Slabs and showcase cards</p><h2>Graded cards</h2><p>Certified cards added through intake publish here when they are made visible online, with grades and cert details preserved in inventory.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-sealed-products/">Sealed</a><a href="/shop-graded-cards/">Graded</a><a href="/shop-accessories/">Accessories</a><a href="/events/">Events</a><a href="/contact/">Contact</a></nav></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>Graded</span><strong>Slabs and showcase cards</strong></aside></section>[tcg_product_shelf category="graded-cards" label="Graded Cards" limit="24"]</div>',
  },
  {
    slug: "shop-accessories",
    title: "Shop Accessories",
    content:
      '<div class="tcg-storefront-shelf tcg-storefront-shelf--accessories"><section class="tcg-storefront-shelf__hero"><div class="tcg-storefront-shelf__hero-copy"><p class="tcg-storefront-shelf__kicker">Gear for play nights</p><h2>Accessories</h2><p>Sleeves, deck boxes, binders, dice, mats, and table gear live here once they are categorized for online sale.</p><nav class="tcg-storefront-shelf__nav" aria-label="Store shelves"><a href="/shop-singles/">Singles</a><a href="/shop-sealed-products/">Sealed</a><a href="/shop-graded-cards/">Graded</a><a href="/shop-accessories/">Accessories</a><a href="/events/">Events</a><a href="/contact/">Contact</a></nav></div><aside class="tcg-storefront-shelf__badge" aria-label="The Pug"><span>Gear</span><strong>Sleeves, dice, mats, supplies</strong></aside></section>[tcg_product_shelf category="accessories" label="Accessories" limit="24"]</div>',
  },
  {
    slug: "card-inventory",
