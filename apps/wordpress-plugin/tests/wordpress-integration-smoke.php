...
$assert( 14 === (int) ( $data['inventory_route_dependencies']['permission_callback_count'] ?? 0 ), 'Inventory route dependencies should expose protected and staff-fallback callbacks inside WordPress.' );
...
$assert( true === ( $data['inventory_route_dependencies']['public_read_permission_callbacks_configured'] ?? null ), 'Inventory public-read contracts should retain staff-capability fallback callbacks.' );
