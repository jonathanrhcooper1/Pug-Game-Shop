	...
	public function admin_summary(): array {
		...
		return array(
			'value'  => sprintf(
				...
				true === ( $payload['push_canonical_mutation_transaction_preflight_ready'] ?? false ) ? 'ready' : 'not ready',
