<?php
/**
 * Guarded POS/payment REST route registrar.
 *
...
final class PosPaymentRouteRegistrar {
	private PosPaymentRouteRegistrationPlanner $planner;
	...
	public function __construct(
		PosPaymentRouteRegistrationPlanner $planner,
