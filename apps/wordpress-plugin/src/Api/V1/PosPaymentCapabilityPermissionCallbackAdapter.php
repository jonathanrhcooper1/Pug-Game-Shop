<?php
/**
 * Capability-based permission callback for planned POS/payment routes.
 *
...
final class PosPaymentCapabilityPermissionCallbackAdapter {
	 ...
	 */
	public function __construct( string $capability, ?callable $capability_checker = null ) {
	...
	private function audit_payload( string $status, array $errors ): array {
		return array(
			'action'             => 'pos_payment_capability_permission_callback',
			'status'             => $status,
