<?php
/**
 * Guarded inventory REST route registrar.
 *
...
final class InventoryRouteRegistrar {
	private InventoryRouteRegistrationPlanner $planner;
	...
	public function __construct(
		InventoryRouteRegistrationPlanner $planner,
