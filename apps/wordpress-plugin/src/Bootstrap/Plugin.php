...
use TCGStorePlatform\Api\V1\InventoryProjectionController;
...
use TCGStorePlatform\Api\V1\ScryDexWebhookRelayController;
...
final class Plugin {
	...
	public function initialize(): void {
		...
		( new InventoryProjectionController() )->register();
		...
		( new ProductShelfShortcode() )->register();
		...
		( new ScryDexWebhookRelayController() )->register();
