<?php
/**
 * Provider price observations schema migration.
 *
...
final class Version0010ProviderPriceObservations implements Migration {
	public function version(): int {
		return 10;
	}

	public function name(): string {
		return 'provider_price_observations';
	}

	public function up( \wpdb $database ): void {
		require_once ABSPATH . 'wp-admin/includes/upgrade.php';

		$tables = ProviderPriceObservationSchema::tables(
			$database->prefix,
	...
	public function down( \wpdb $database ): void {
		foreach ( ProviderPriceObservationSchema::drop_order( $database->prefix ) as $table_name ) {
	...
	public function checksum(): string {
		return hash(
			...
			implode(
				"\n",
				ProviderPriceObservationSchema::tables( 'wp_', 'DEFAULT CHARACTER SET utf8mb4' )
			)
		);
	}
}
