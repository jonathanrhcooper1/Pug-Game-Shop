<?php
/**
 * Reference card image URL schema migration.
 *
...
final class Version0011ReferenceCardImages implements Migration {
	public function version(): int {
		return 11;
	}

	public function name(): string {
		return 'reference_card_images';
	}

	public function up( \wpdb $database ): void {
		$table_name = $database->prefix . 'tcg_reference_cards';
	...
	public function checksum(): string {
		return hash( 'sha256', 'tcg_reference_cards.front_image_url.back_image_url.v1' );
	}
