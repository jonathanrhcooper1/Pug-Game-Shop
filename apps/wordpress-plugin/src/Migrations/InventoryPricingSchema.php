...
reference_set_id bigint(20) unsigned NULL,
provider_set_id varchar(191) NULL,
...
KEY provider_set (provider_name, provider_set_id),
KEY reference_set_card (reference_set_id, card_number),
KEY game_name (game, normalized_name),
KEY set_lookup (set_code, card_number),
KEY game_set_card (game, provider_set_id, card_number),
...
quantity_on_hand int(10) unsigned NOT NULL DEFAULT 1,
...
square_catalog_item_id varchar(191) NULL,
square_catalog_variation_id varchar(191) NULL,
external_sync_state varchar(32) NOT NULL DEFAULT 'pending',
...
KEY woocommerce_product (woocommerce_product_id),
KEY square_catalog_variation (square_catalog_variation_id),
KEY external_sync_state (external_sync_state, last_external_sync_at),
