...
final class Version0006Sync implements Migration {
	...
	public function down( \wpdb $database ): void {
		foreach ( SyncSchema::drop_order( $database->prefix ) as $table_name ) {
	...
	public function checksum(): string {
		return hash(
			...
			implode(
				"\n",
				SyncSchema::tables( 'wp_', 'DEFAULT CHARACTER SET utf8mb4' )
			)
		);
	}
}
