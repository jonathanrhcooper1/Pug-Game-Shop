...
final class Version0005Buylist implements Migration {
	...
	public function down( \wpdb $database ): void {
		foreach ( BuylistSchema::drop_order( $database->prefix ) as $table_name ) {
	...
	public function checksum(): string {
		return hash(
			...
			implode(
				"\n",
				BuylistSchema::tables( 'wp_', 'DEFAULT CHARACTER SET utf8mb4' )
			)
		);
	}
}
