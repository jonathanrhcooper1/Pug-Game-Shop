...
assert.equal(observedRequest.body.source, "square_pos")
...
assert.equal(observedRequest.body.square_cashier_confirmed, true)
assert.equal(observedRequest.body.sale_total_minor_units, 25000)
...
assert.deepEqual(rejected.errors, ["square_reference_required"])
