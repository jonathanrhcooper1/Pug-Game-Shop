...
for (const requiredExport of [
  ...
  "LocalSyncOutboxDelivery",
  "LocalSyncOutboxDeliveryListResult",
  "LocalSyncOutboxReplayResult",
  "LocalSyncPullResult",
  "LocalSyncPushResult",
...
for (const marker of [
  ...
  "auto_sync_results",
  "local_queue_depth",
  "sync_outbox_deliveries_listed",
  "sync_outbox_delivery_replayed",
